...
public final class SnWindow {
    private static final Logger LOG = ScLogHandler.logger(SnWindow.class);
     ...
     * @param predicate
     */
    public <T extends ScPage> void inWindow(SnWithPage<T> withPage, SnWindowAction<T> predicate) {
     ...
     * @param predicate
     */
    public <T extends ScPage> void inWindow(SnWithPage<T> withPage, SnWindowActionWithController<T> predicate) {
     ...
     */
    private <T extends ScPage> void inWindow(SnWithPage<T> withPage, SnWindowAction<T> predicate, SnWindowActionWithController<T> controllerPredicate) {
    ...
    public final class SnWindowController {
         ...
         * @param predicate
         */
        public <T extends ScPage> void inOtherWindow(SnWithPage<T> withPage, int index, SnWindowAction<T> predicate) {
