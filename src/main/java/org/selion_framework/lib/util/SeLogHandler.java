...
public final class SeLogHandler {
    ...
    static void setLogDirectory(File logDirectory) {
        SeLogHandler.logDirectory = logDirectory;
    }
    ...
    public static File artifactDirectory() {
        ...
        try {
            ...
            throw new SeLoggerException("Failed to create artifact directory: " + artifactDirectory.getAbsolutePath(), ex);
        }
    }
