...
import org.selion_framework.lib.exception.SnComponentNotEnabledException;
 ...
 * <ol>
 *   <li>Wait for element to exist and be enabled (using default timeout from {@link org.selion_framework.lib.config.SelionConfig})</li>
