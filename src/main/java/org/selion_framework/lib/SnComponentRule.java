...
public class SnComponentRule {
    ...
    public class RuleCondition {
        ...
        public void isPresent() {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.IsPresent, actualValue));
        }

        public void isAbsent() {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.IsAbsent, actualValue));
        }

        public void is(String expected) {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.Is, actualValue, expected));
        }

        public void isNot(String expected) {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.IsNot, actualValue, expected));
        }

        public void isOneOf(String... expected) {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.IsOneOf, actualValue, expected));
        }

        public void doesNotContain(String expected) {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.DoesNotContain, actualValue, expected));
        }

        public void contains(String expected) {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.Contains, actualValue, expected));
        }

        public void startsWith(String expected) {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.StartsWith, actualValue, expected));
        }

        public void endsWith(String expected) {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.EndsWith, actualValue, expected));
        }

        public void matches(String regexPattern) {
            SnComponentRule.this.ruleResults.add(new RuleResult(valueType, RuleType.Matches, actualValue, regexPattern));
        }
    }
    ...
    public class CssClassRuleCondition {
        ...
        public void isPresent() {
            SnComponentRule.this.ruleResults.add(new CssClassRunResult(CssClassRuleType.IsPresent, actualCssClasses));

        }

        public void isAbsent() {
            SnComponentRule.this.ruleResults.add(new CssClassRunResult(CssClassRuleType.IsAbsent, actualCssClasses));
        }

        public void has(String expectedCssClass) {
            SnComponentRule.this.ruleResults.add(new CssClassRunResult(CssClassRuleType.Has, actualCssClasses, new String[] { expectedCssClass }));
        }

        public void doesNotHave(String expectedCssClass) {
            SnComponentRule.this.ruleResults.add(new CssClassRunResult(CssClassRuleType.DoesNotHave, actualCssClasses, new String[] { expectedCssClass }));
        }

        public void hasAllOf(String... expectedCssClasses) {
            SnComponentRule.this.ruleResults.add(new CssClassRunResult(CssClassRuleType.HasAllOf, actualCssClasses, expectedCssClasses));
        }

        public void hasAnyOf(String... expectedCssClasses) {
            SnComponentRule.this.ruleResults.add(new CssClassRunResult(CssClassRuleType.HasAnyOf, actualCssClasses, expectedCssClasses));
        }

        public void hasNoneOf(String... expectedCssClasses) {
            SnComponentRule.this.ruleResults.add(new CssClassRunResult(CssClassRuleType.HasNoneOf, actualCssClasses, expectedCssClasses));
        }
    }
