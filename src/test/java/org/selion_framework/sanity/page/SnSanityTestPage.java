...
public class SnSanityTestPage extends SnPage {
    private static final SnXPathSelector SANITYTEST_TEXTBOX = _xpath.descendant("input", _id().is("sanitytest-textbox"));
    private static final SnXPathSelector SANITYTEST_TEXTAREA_TEXTBOX = _xpath.descendant("textarea", _id().is("sanitytest-textarea"));
    private static final SnXPathSelector SANITYTEST_DATE_TEXTBOX = _xpath.descendant("input", _id().is("sanitytest-date-textbox"));
    private static final SnXPathSelector SANITYTEST_DROPDOWN = _xpath.descendant("select", _id().is("sanitytest-dropdown"));
    private static final SnXPathSelector SANITYTEST_MULTI_SELECT = _xpath.descendant("select", _id().is("sanitytest-multi-select"));
    private static final SnXPathSelector SANITYTEST_CHECKBOX = _xpath.descendant("input", _id().is("sanitytest-checkbox"));
    private static final SnXPathSelector SANITYTEST_RADIO_BUTTONS = _xpath.descendant("input", _name().is("sanitytest-radio-buttons"));
    private static final SnXPathSelector SANITYTEST_INPUT_BUTTON = _xpath.descendant("input", _id().is("sanitytest-input-button"));
    private static final SnXPathSelector SANITYTEST_INPUT_BUTTON_INDICATOR_TEXT = _xpath.descendant("span", _id().is("sanitytest-input-button-indicator"));
    private static final SnXPathSelector SANITYTEST_BUTTON = _xpath.descendant("button", _id().is("sanitytest-button"));
    private static final SnXPathSelector SANITYTEST_BUTTON_INDICATOR_TEXT = _xpath.descendant("span", _id().is("sanitytest-button-indicator"));
    private static final SnXPathSelector SANITYTEST_IFRAME = _xpath.descendant("iframe", _id().is("sanitytest-iframe"));
    private static final SnXPathSelector SANITYTEST_TABLE_ROWS = _xpath.descendant("table", _id().is("sanitytest-table")).descendant("tr", _cssClasses("data"));
    private static final SnXPathSelector OPEN_EXTERNAL_WINDOW_LINK = _xpath.descendant("a", _id().is("sanitytest-external-window-link"));
    private static final SnXPathSelector SANITYTEST_LONG_COMPONENT_LIST = _xpath.descendant("div", _id().is("long-component-list")).child("div", _cssClasses("long-component-list-entry"));
    private static final SnXPathSelector SANITYTEST_CSV_DOWNLOAD_LINK = _xpath.descendant("a", _id().is("sanitytest-csv-download-link"));
    private static final SnXPathSelector SANITYTEST_OWN_TEXT = _xpath.descendant("div", _id().is("sanitytest-own-text"));

    private static final SnXPathSelector OPEN_SANITYTEST_DIALOG_BUTTON = _xpath.descendant("button", _id().is("open-sanitytest-dialog-button"));
    private static final SnXPathSelector OPEN_SANITYTEST_MODAL_DIALOG_BUTTON = _xpath.descendant("button", _id().is("open-sanitytest-modal-dialog-button"));

    private static final SnXPathSelector SANITYTEST_DIALOG = _xpath.descendant("div", _id().is("sanitytest-dialog"));
    private static final SnXPathSelector SANITYTEST_MODAL_DIALOG = _xpath.descendant("dialog", _id().is("sanitytest-modal-dialog"));
