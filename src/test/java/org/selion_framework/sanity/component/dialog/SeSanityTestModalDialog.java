...
public class SeSanityTestModalDialog extends SeDialog {
    private static final SeLocatorNode TEXTBOX = _xpath.descendant("input", _id().is("sanitytest-modal-dialog-textbox"));
