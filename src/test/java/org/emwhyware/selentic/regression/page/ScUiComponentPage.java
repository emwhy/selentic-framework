...
public class ScUiComponentPage extends ScPage {
    ...
    public final SnRadioButtonGroup<ScRadioButton> testRadioButtons = $radioButtons(TEST_RADIO_BUTTONS);
    ...
    public final SnComponentCollection<ScTestTableRow> testTableRows = $$components(TEST_TABLE_ROWS, ScTestTableRow.class);
    public final ScLink openExternalWindowLink = $component(OPEN_EXTERNAL_WINDOW_LINK, ScLink.class);
    public final SnComponentCollection<ScLongListEntryComponent> longComponentEntries = $$components(TEST_LONG_COMPONENT_LIST, ScLongListEntryComponent.class);
    ...
    public void inSanityTestInnerFrame(SnFrameAction<ScSanityTestFrameContent> predicate) {
        $frame(TEST_IFRAME, ScSanityTestFrameContent.class, predicate);
    }

    public void inSanityTestDialog(SnDialogAction<ScTestDialog> predicate) {
        $dialog(TEST_DIALOG, ScTestDialog.class, predicate);
    }

    public void inSanityTestModalDialog(SnDialogAction<ScTestModalDialog> predicate) {
