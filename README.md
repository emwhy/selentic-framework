...
- Download the latest **selentic-framework-release.jar** file from https://github.com/emwhy/selentic-framework/releases/. The javadoc for the framework is packaged in  ***selentic-framework-release-javadoc.jar***. When configured, the documentation can be shown right from IDE (such as IntelliJ).
...
```
- **selentic-framework-release.jar** can be added to the dependency like this.
```
    implementation(files("lib/selentic-framework-release.jar"));
```
